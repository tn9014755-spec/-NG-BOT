...
function latestReportContext(){
 const parts=[];
 try{if(fresh.exists()&&typeof fresh.aiContext==="function"){const x=fresh.aiContext();if(x)parts.push("DỮ LIỆU FRESH & ĐÔNG MÁT MỚI NHẤT:\n"+x)}}catch(e){console.warn("⚠️ Không đọc được DATA FRESH cho AI:",e.message)}
